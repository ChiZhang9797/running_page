    ...
    <Layout>
      <div className="mb5">
        <div className="w-100">
          ...
          <iframe style={{borderRadius:'12px'}} src="https://open.spotify.com/embed/album/50o7kf2wLwVmOTVYJOTplm?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
            <a href="/">{siteTitle}</a>
          </h1>
        </div>
