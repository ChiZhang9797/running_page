...
class _API_FUNCTIONS(object):
    def __init__(
        self, _in_scalar, _out_scalar, _in_collection, _out_unordered, _out_ordered
    ):
    ...
    def versions():
        ...
        v = {"c": _cy.c_version(), "python": __version__}
    ...
    def hex_range_distances(self, h, K):
        ...
        out = [self._out_unordered(_cy.ring(h, k)) for k in range(K + 1)]
