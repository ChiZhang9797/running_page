...
class Input(TransformSpec):
    ...
    def __init__(
        self, source=None, source_path=None, encoding=None, error_handler="strict"
    ):
    ...
    def decode(self, data):
        ...
        if self.encoding and self.encoding.lower() == "unicode":
            assert isinstance(data, str), (
                'input encoding is "unicode" ' "but input is not a `str` object"
            )
...
class ErrorOutput:
    ...
    def write(self, data):
        ...
        try:
            ...
            self.destination.write(data.encode(self.encoding, self.encoding_errors))
        except TypeError:
            if isinstance(data, str):  # destination may expect bytes
                ...
                self.destination.write(str(data, self.encoding, self.decoding_errors))
