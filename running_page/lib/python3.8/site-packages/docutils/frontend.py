...
class Values(optparse.Values):
    ...
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "frontend.Values class will be removed " "in Docutils 0.21 or later.",
            DeprecationWarning,
            stacklevel=2,
        )
...
class OptionParser(optparse.OptionParser, docutils.SettingsSpec):
    ...
    default_error_encoding = (
        getattr(sys.stderr, "encoding", None) or io._locale_encoding or "ascii"  # noqa
    )
...
"""
    ...
    def get_section(self, section):
        ...
        """
        warnings.warn(
            "frontend.OptionParser.get_section() "
