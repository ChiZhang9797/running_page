...
class Writer(writers.Writer):
    ...
    def create_manifest(self):
        ...
        SubElement(
            root,
            "manifest:file-entry",
            attrib={"manifest:media-type": self.MIME_TYPE, "manifest:full-path": "/"},
            nsdict=MANNSD,
        )
        SubElement(
            root,
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def __init__(self, document):
        ...
        root = Element("office:document-content", attrib=CONTENT_NAMESPACE_ATTRIB)
    ...
    def add_doc_title(self):
        ...
        if text:
            ...
            if not self.found_doc_title:
                el = Element(
                    "text:p", attrib={"text:style-name": self.rststyle("title")}
                )
                el.text = text
    ...
    def create_custom_headfoot(self, parent, text, style_name, automatic_styles):
        parent = SubElement(
            parent, "text:p", attrib={"text:style-name": self.rststyle(style_name)}
        )
        ...
        if self.in_table_of_contents:
            if self.settings.generate_oowriter_toc:
                ...
                if "classes" in node and "auto-toc" in node.attributes["classes"]:
                    el = SubElement(
                        ...
                        "text:list",
                        attrib={"text:style-name": self.rststyle("tocenumlist")},
                    )
                    ...
                    el = SubElement(
                        self.current_element,
                        "text:list",
                        attrib={"text:style-name": self.rststyle("tocbulletlist")},
                    )
            ...
            if self.blockstyle == self.rststyle("blockquote"):
                el = SubElement(
                    self.current_element,
                    "text:list",
                    attrib={"text:style-name": self.rststyle("blockquote-bulletlist")},
                )
                ...
                el = SubElement(
                    self.current_element,
                    "text:list",
                    attrib={"text:style-name": self.rststyle("highlights-bulletlist")},
                )
                ...
                el = SubElement(
                    self.current_element,
                    "text:list",
                    attrib={"text:style-name": self.rststyle("epigraph-bulletlist")},
                )
    ...
    def visit_enumerated_list(self, node):
        ...
        if self.blockstyle == self.rststyle("blockquote"):
            el2 = SubElement(
                el1,
                "text:list",
                attrib={"text:style-name": self.rststyle("blockquote-enumlist")},
            )
            ...
            el2 = SubElement(
                el1,
                "text:list",
                attrib={"text:style-name": self.rststyle("highlights-enumlist")},
            )
            ...
            el2 = SubElement(
                el1,
                "text:list",
                attrib={"text:style-name": self.rststyle("epigraph-enumlist")},
            )
    ...
    def visit_footnote_reference(self, node):
        if self.footnote_level <= 0:
            ...
            el1 = self.append_child(
                "text:note",
                attrib={"text:id": "%s" % (refid,), "text:note-class": note_class},
            )
            ...
            if isinstance(node, docutils.nodes.citation_reference):
                ...
                el2 = SubElement(
                    el1, "text:note-citation", attrib={"text:label": node.astext()}
                )
                el2.text = node.astext()
            elif note_auto == "*":
                ...
                el2 = SubElement(
                    el1, "text:note-citation", attrib={"text:label": footnote_char}
                )
    ...
    def visit_citation_reference(self, node):
        if self.settings.create_links:
            ...
            el = self.append_child(
                "text:reference-ref",
                attrib={"text:ref-name": "%s" % (id,), "text:reference-format": "text"},
            )
            el.text = "["
            self.set_current_element(el)
    ...
    def visit_reference(self, node):
        ...
        if self.settings.create_links:
            if "refuri" in node:
                ...
                el = self.append_child(
                    "text:a", attrib={"xlink:href": "%s" % href, "xlink:type": "simple"}
                )
                self.set_current_element(el)
            elif "refid" in node:
                if self.settings.create_links:
    ...
    def visit_colspec(self, node):
        ...
        colspec_name = self.rststyle(
            "%s%%d.%%s" % TABLESTYLEPREFIX, (self.table_count, chr(self.column_count))
        )
        colwidth = node["colwidth"] / 12.0
        el1 = SubElement(
            self.automatic_styles,
            "style:style",
            attrib={"style:name": colspec_name, "style:family": "table-column"},
            nsdict=SNSD,
        )
        SubElement(
            el1,
            ...
            if "contents" in node.attributes["classes"]:
                ...
                if self.settings.generate_oowriter_toc:
                    ...
                    el6 = SubElement(
                        el5,
                        "text:p",
                        attrib={"text:style-name": self.rststyle("contents-heading")},
                    )
                    el6.text = label
    ...
    def generate_admonition(self, node, label, title=None):
        ...
        el1 = SubElement(
            self.current_element,
            "text:p",
            attrib={"text:style-name": self.rststyle("admon-%s-hdr", (label,))},
        )
        if title:
            el1.text = title
        else:
