...
class Writer(writers.Writer):
    ...
    def translate(self):
        ...
        try:
            ...
            templatepath = os.path.join(self.default_template_path, templatepath)
            with open(templatepath, encoding="utf-8") as fp:
                template = fp.read()
        # fill template
...
_docutils_sty = os.path.join(os.path.dirname(os.path.abspath(__file__)), "docutils.sty")
...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    def __init__(self, document, babel_class=Babel):
        ...
        if self.fallback_stylesheet:
            stylesheet_list = [
                sheet for sheet in stylesheet_list if sheet != "docutils"
            ]
    ...
    def visit_subtitle(self, node):
        if isinstance(node.parent, nodes.document):
            ...
            if not self.fallback_stylesheet:
                self.fallbacks[
                    "documentsubtitle"
                ] = PreambleCmds.documentsubtitle  # noqa:E501
            protect = self.settings.documentclass == "memoir"
