...
if TYPE_CHECKING:
    ...
    class Dataclass:
        ...
        __has_field_info_default__: ClassVar[
            bool
        ]  # whether or not a `pydantic.Field` is used as default value
...
def _generate_pydantic_post_init(
    post_init_original: Optional[Callable[..., None]],
    post_init_post_parse: Optional[Callable[..., None]],
) -> Callable[..., None]:
...
def _process_class(
    ...
    _pydantic_post_init = _generate_pydantic_post_init(
        post_init_original, post_init_post_parse
    )
    ...
    if is_builtin_dataclass(_cls):
        ...
        _cls = type(
            ...
            (_cls,),
            {
                "__annotations__": resolve_annotations(
                    _cls.__annotations__, _cls.__module__
                ),
                "__post_init__": _pydantic_post_init,
...
def make_dataclass_validator(
    ...
    stdlib_dataclass_parameters = {
        param: getattr(dataclass_params, param) for param in dataclass_params.__slots__
    }
