...
LSP_METHODS_MAP = {
    ...
    COMPLETION_ITEM_RESOLVE: (None, CompletionItem, CompletionItem),
    HOVER: (HoverOptions, HoverParams, Optional[Hover]),
    SIGNATURE_HELP: (
    ...
    REFERENCES: (ReferenceOptions, ReferenceParams, Optional[List[Location]]),
    DOCUMENT_HIGHLIGHT: (
    ...
    CODE_ACTION_RESOLVE: (None, CodeAction, CodeAction),
    CODE_LENS: (CodeLensOptions, CodeLensParams, Optional[List[CodeLens]]),
    CODE_LENS_RESOLVE: (None, CodeLens, CodeLens),
    DOCUMENT_LINK: (
        DocumentLinkOptions,
        DocumentLinkParams,
        Optional[List[DocumentLink]],
    ),
    DOCUMENT_LINK_RESOLVE: (None, DocumentLink, DocumentLink),
    DOCUMENT_COLOR: (DocumentColorOptions, DocumentColorParams, List[ColorInformation]),
    COLOR_PRESENTATION: (None, ColorPresentationParams, List[ColorPresentation]),
    FORMATTING: (
    ...
    RENAME: (RenameOptions, RenameParams, Optional[WorkspaceEdit]),
    PREPARE_RENAME: (None, PrepareRenameParams, Union[Range, PrepareRename, None]),
    FOLDING_RANGE: (
        FoldingRangeOptions,
        FoldingRangeParams,
