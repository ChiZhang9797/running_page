...
class RandomState:
    ...
    @overload
    def beta(
        self, a: float, b: float, size: None = ...
    ...
    def standard_gamma(  # type: ignore[misc]
        self, shape: float, size: None = ...
    ) -> float: ...
    @overload
    def standard_gamma(
        self, shape: _ArrayLikeFloat_co, size: None | _ShapeLike = ...
    ) -> ndarray[Any, dtype[float64]]: ...
    @overload
    def gamma(
    ...
    @overload
    def f(
        self, dfnum: float, dfden: float, size: None = ...
    ) -> float: ...  # type: ignore[misc]
    @overload
    def f(
        self,
    ...
    @overload
    def vonmises(
        self, mu: float, kappa: float, size: None = ...
    ) -> float: ...  # type: ignore[misc]
    @overload
    def vonmises(
        self,
    ...
    @overload
    def wald(
        self, mean: float, scale: float, size: None = ...
    ) -> float: ...  # type: ignore[misc]
    @overload
    def wald(
        self,
