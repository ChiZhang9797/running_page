...
from typing import Any, overload, TypeVar, Literal, SupportsAbs, SupportsIndex, NoReturn
...
@overload
def identity(
    n: int, dtype: None = ..., *, like: _SupportsArrayFunc = ...
) -> NDArray[float64]: ...
@overload
def identity(
    n: int, dtype: _DTypeLike[_SCT], *, like: _SupportsArrayFunc = ...
) -> NDArray[_SCT]: ...
@overload
def identity(
    n: int, dtype: DTypeLike, *, like: _SupportsArrayFunc = ...
) -> NDArray[Any]: ...
def allclose(
    a: ArrayLike,
    b: ArrayLike,
